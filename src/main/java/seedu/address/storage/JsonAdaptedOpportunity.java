...
class JsonAdaptedOpportunity {
     ...
     */
    @JsonCreator
    public JsonAdaptedOpportunity(@JsonProperty("name") String name, @JsonProperty("phone") String phone,
    ...
    public Opportunity toModelType() throws IllegalValueException {
        final List<Tag> opportunityTags = new ArrayList<>();
        for (JsonAdaptedTag tag : tags) {
            opportunityTags.add(tag.toModelType());
        }
        ...
        final Set<Tag> modelTags = new HashSet<>(opportunityTags);
        return new Opportunity(modelName, modelPhone, modelEmail, modelAddress, modelTags);
    }
